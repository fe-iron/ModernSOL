...
<?php
  ...
  $sql = 'SELECT * FROM batches where language="Spanish"';
        ...
        <div class="pt-3">
          ...
          <a class="list active" onclick="openLan()">Classes</a>
                ...
                <a href="french_classes.php" class="list">French Classes</a>
                    <a href="spanish_classes.php" class="list active">Spanish Classes</a>
              ...
              <div class="col-md-10">
                  <div class="card">
                      <nav class="navbar navbar-light border venue-registration border-bottom">
                          <a class="h4 text-dark font-weight-bold pt-2"> My Spanish Batches</a>

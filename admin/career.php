...
<?php
    ...
    if(isset($_POST['remove_id'])){
        ...
        $sql = "DELETE FROM career WHERE id=".$remove_id;    
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="border-right text-center">Mode of Teaching</th> 
                                    ...
                                    <th scope="col" class="border-right text-center">Resume</th>      
                                ...
                                <tbody> 
                                    ...
                                    while($data = mysqli_fetch_assoc($enquiry_form)){ 
                                        ...
                                        <td class="border-right border-left text-center"><?php echo $data['mode_of_teaching']; ?></td>
                                        ...
                                        <td class="border-right border-left text-center"> <a href="upload/career/<?php echo $data['resume']; ?>"><?php echo $data['resume']; ?></a></td>
                                        <td>

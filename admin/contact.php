...
<?php
    ...
    if(isset($_POST['remove_id'])){
        ...
        $sql = "DELETE FROM contact WHERE id=".$remove_id;    
    ...
    <div class="logo">
      ...
      <div class="pt-3">
        <div class="pt-3">
          ...
          <a href="contact.php" class="list active">Contact</a>
        ...
        <h4 class="mx-4 text-success"><?php 
            ...
            <div class="card">
                <nav class="navbar navbar-light border venue-registration border-bottom">
                    <a class="h4 text-dark font-weight-bold pt-2">Contact Forms</a>
                ...
                <div class="card-body ">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody> 
                                    <?php $count = 0;
                                    while($data = mysqli_fetch_assoc($contact_form)){ 
                                        $count = $count + 1; ?>
                                        ...
                                        <td class="border-right border-left text-center"><?php echo $data['spanish_level']; ?></td>
                                        <td class="border-right border-left text-center"><?php echo $data['german_level']; ?></td>
                                        <td class="border-right border-left text-center"><?php echo $data['french_level']; ?></td>
                                        <td>

...
<?php
    ...
    $sql = 'SELECT * FROM students WHERE course="German" ORDER BY id DESC';
    ...
    <div class="logo">
      ...
      <div class="pt-3">
        <div class="pt-3">
          ...
          <a href="german_student.php" class="list active">German Students</a>
        ...
        <h4 class="mx-4 text-success"><?php 
            ...
            <div class="card">
                <nav class="navbar navbar-light border venue-registration border-bottom">
                    <a class="h4 text-dark font-weight-bold pt-2">German Students</a>

    ...
    if ($rows == 1) {
        if ($conf_p == $new_p) {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($this_p == $old_p) {
                    $result = mysqli_query($conn, "UPDATE students SET password='$new_p', is_password_set=1 WHERE email='$email'");
                    if ($result) {
                    ...
                    $_SESSION['error'] = "Old password does not match! Try Again";
                }
            } else {
                $_SESSION['error'] = "Something went wrong! Try Again";
            }
        } else {
            $_SESSION['error'] = "Passwords does not match! Try again";
        }
    } else {
        $_SESSION['error'] = "Email is not registered with us! Make a new registration";
    }
}
?>
                            ...
                            <div class="card-body border-bottom py-3">
                                <form action=" " method="post">
                                    ...
                                    <div class="row g-2 justify-content-center">
                                        <div class="col-md mb-3 ">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingInputGrid" placeholder="Enter Contact Number" name="old_p" required>
